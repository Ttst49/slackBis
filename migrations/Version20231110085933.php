 ...
 */
final class Version20231110085933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE group_conversation ADD owner_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_66C86CD07E3C61F9');
        $this->addSql('ALTER TABLE group_conversation DROP owner_id');
    }
}
